  ...
  const fetchStudents = async () => {
    ...
    try {
      const res = await axios.get(
        'https://bonde-backend-navy.vercel.app/api/students/all'
      );
      ...
      fetchedStudents.forEach((student) => {
        const monthData =
          student.year_month?.[currentYear]?.months?.[currentMonth];
            ...
            <div className="relative bg-gradient-to-r from-purple-700 via-blue-700 to-indigo-700 rounded-2xl p-10 mb-10 text-white shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg sm:text-xl font-light mb-6 max-w-3xl drop-shadow-md">
                  Above Dheeraj Infotech, Behind Darji Foundation, Near
                  Khwajamia Dargah, Jalgaon 425 001.
                </p>
                ...
                >
                  <UserPlusIcon className="inline-block mr-2" /> Add a New
                  Student
                </button>
              </div>
    ...
    <div className="flex min-h-screen bg-gray-100 font-sans">
      ...
      <aside className="w-64 bg-gray-900 text-white p-6 shadow-lg flex flex-col">
        <div className="text-2xl font-extrabold mb-8 text-blue-400">
          Swarajya Study Point
        </div>
        <nav className="space-y-2">
          <div
            onClick={() => setCurrentPage('dashboard')}
            role="button"
            className={`cursor-pointer flex items-center p-3 rounded-lg hover:bg-gray-700 transition duration-200 ${
          ...
          <div
            ...
            role="button"
            className={`cursor-pointer flex items-center p-3 rounded-lg hover:bg-gray-700 transition duration-200 ${
              currentPage === 'view-fees' ? 'bg-gray-800' : ''
            }`}
          >
